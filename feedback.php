...
.feedback form .btn-primary:hover, .register form .btn-primary:active {
  background: blue;
}
...
<form method="post">
<h1 class="text-center"><strong>Feedback</strong></h1>
    ...
    <div class="container mb-3 mt-3">
  		...
  		<div class="mb-3 mt-3">
    		<label for="comment" class="form-label">Write Your Comment:</label>
    			<input type="comment" class="form-control" id="message" placeholder="Write Your Comment" name="comment"> <br>
  		</div>
